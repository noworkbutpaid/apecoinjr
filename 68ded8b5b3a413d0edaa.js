/*!For license information please see 68ded8b5b3a413d0edaa.js.LICENSE.txt*/ ! function(t, e) {
    ...
    var o, a, l, h, c, u, f, d, g, _, p, m, v, E, y, C, T, b, I = function(t) {
            var e = !1;
            var n = {
        ...
        A = (g = "button", p = "." + (_ = "bs.button"), m = ".data-api", v = (d = e).fn[g], E = "active", "btn", "focus", y = '[data-toggle^="button"]', '[data-toggle="buttons"]', "input", ".active", C = ".btn", T = {
        ...
        D = function(t) {
            var e = "carousel",
                ...
                _ = ".carousel-item",
                p = ".carousel-item-next, .carousel-item-prev",
                m = ".carousel-indicators",
                v = "[data-slide], [data-slide-to]",
                E = '[data-ride="carousel"]',
                y = function() {
                    function o(e, n) {
                        this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this._isSliding = !1, this.touchTimeout = null, this._config = this._getConfig(n), this._element = t(e)[0], this._indicatorsElement = t(this._element).find(m)[0], this._addEventListeners()
                    }
                    var v = o.prototype;
                    return v.next = function() {
                        ...
                        e || (this._isPaused = !0), t(this._element).find(p)[0] && I.supportsTransitionEnd() && (I.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
                    }, v.cycle = function(t) {
                    ...
                    }, v._getItemIndex = function(e) {
                        return this._items = t.makeArray(t(e).parent().find(_)), this._items.indexOf(e)
                        ...
                        var i = this._getItemIndex(e),
                            s = this._getItemIndex(t(this._element).find(g)[0]),
                            r = t.Event(u.SLIDE, {
                                relatedTarget: e,
                                direction: n,
                                from: s,
                        ...
                        if (this._indicatorsElement) {
                            t(this._indicatorsElement).find(d).removeClass(f);
                            var n = this._indicatorsElement.children[this._getItemIndex(e)];
                            n && t(n).addClass(f)
                        }
                    }, v._slide = function(e, n) {
                        var i, s, r, o = this,
                            a = t(this._element).find(g)[0],
                        ...
                        if (e === h ? (i = "carousel-item-left", s = "carousel-item-next", r = "left") : (i = "carousel-item-right", s = "carousel-item-prev", r = "right"), c && t(c).hasClass(f)) this._isSliding = !1;
                            ...
                            })).emulateTransitionEnd(600)) : (t(a).removeClass(f), t(c).addClass(f), this._isSliding = !1, t(this._element).trigger(p)), _ && this.cycle()
                        }
            ...
            return t(document).on(u.CLICK_DATA_API, v, y._dataApiClickHandler), t(window).on(u.LOAD_DATA_API, (function() {
                t(E).each((function() {
                    var e = t(this);
        ...
        S = function(t) {
            var e = "collapse",
                ...
                m = function() {
                    function i(e, n) {
                        ...
                        for (var i = t(p), s = 0; s < i.length; s++) {
                            var r = i[s],
                    ...
                    return o.toggle = function() {
                        ...
                        var e, s, r = this;
                        if (!this._isTransitioning && !t(this._element).hasClass(c) && (this._parent && 0 === (e = t.makeArray(t(this._parent).find(_).filter('[data-parent="' + this._config.parent + '"]'))).length && (e = null), !(e && (s = t(e).not(this._selector).data(n)) && s._isTransitioning))) {
                        ...
                        var e = this,
                            n = null;
                        I.isElement(this._config.parent) ? (n = this._config.parent, "undefined" != typeof this._config.parent.jquery && (n = this._config.parent[0])) : n = t(this._config.parent)[0];
            ...
            return t(document).on(h.CLICK_DATA_API, p, (function(e) {
        ...
        N = function(t) {
            var e = "dropdown",
                ...
                E = function() {
                    ...
                    return l.toggle = function() {
                        ...
                        if ((/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || t(e.target).closest(p).length)) : h.test(e.which)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !t(this).hasClass(u))) {
            ...
            return t(document).on(c.KEYDOWN_DATA_API, _, E._dataApiKeydownHandler).on(c.KEYDOWN_DATA_API, p, E._dataApiKeydownHandler).on(c.CLICK_DATA_API + " " + c.KEYUP_DATA_API, E._clearMenus).on(c.CLICK_DATA_API, _, (function(e) {
        ...
        O = function(t) {
            var e = "bs.modal",
                ...
                v = function() {
                    function i(e, n) {
                        this._config = this._getConfig(n), this._element = e, this._dialog = t(e).find(f)[0], this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._originalBodyPadding = 0, this._scrollbarWidth = 0
                    }
                    var d = i.prototype;
                    return d.toggle = function(t) {
                        ...
                        if (!this._isTransitioning && !this._isShown) {
                            ...
                            t(this._element).trigger(i), this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), t(document.body).addClass(h), this._setEscapeEvent(), this._setResizeEvent(), t(this._element).on(l.CLICK_DISMISS, g, (function(t) {
                                return n.hide(t)
                        ...
                        if (this._isBodyOverflowing) {
                            ...
                            })), t(p).each((function(n, i) {
                                var s = t(i)[0].style.marginRight,
                                    r = t(i).css("margin-right");
                                t(i).data("margin-right", s).css("margin-right", parseFloat(r) - e._scrollbarWidth + "px")
                            })), t(m).each((function(n, i) {
                                var s = t(i)[0].style.marginRight,
                                    r = t(i).css("margin-right");
                                t(i).data("margin-right", s).css("margin-right", parseFloat(r) + e._scrollbarWidth + "px")
                            }));
            ...
            return t(document).on(l.CLICK_DATA_API, d, (function(n) {
                var i, s = this,
                ...
                v._jQueryInterface.call(t(i), a, this)
            ...
            var e = "tooltip",
                ...
                E = function() {
                    ...
                    return E.enable = function() {
                        ...
                        this.setElementContent(e.find(".tooltip-inner"), this.getTitle()), e.removeClass(_ + " " + p)
                        ...
                        this.config.trigger.split(" ").forEach((function(n) {
                            if ("click" === n) t(e.element).on(e.constructor.Event.CLICK, e.config.selector, (function(t) {
                                ...
                                var i = n === m ? e.constructor.Event.MOUSEENTER : e.constructor.Event.FOCUSIN,
                                    s = n === m ? e.constructor.Event.MOUSELEAVE : e.constructor.Event.FOCUSOUT;
                        ...
                        (n = n || t(e.currentTarget).data(i)) || (n = new this.constructor(e.currentTarget, this._getDelegateConfig()), t(e.currentTarget).data(i, n)), e && (n._activeTrigger["focusin" === e.type ? v : m] = !0), t(n.getTipElement()).hasClass(p) || n._hoverState === f ? n._hoverState = f : (clearTimeout(n._timeout), n._hoverState = f, n.config.delay && n.config.delay.show ? n._timeout = setTimeout((function() {
                            n._hoverState === f && n.show()
                        }), n.config.delay.show) : n.show())
                    }, E._leave = function(e, n) {
                        var i = this.constructor.DATA_KEY;
                        (n = n || t(e.currentTarget).data(i)) || (n = new this.constructor(e.currentTarget, this._getDelegateConfig()), t(e.currentTarget).data(i, n)), e && (n._activeTrigger["focusout" === e.type ? v : m] = !1), n._isWithActiveTrigger() || (clearTimeout(n._timeout), n._hoverState = d, n.config.delay && n.config.delay.hide ? n._timeout = setTimeout((function() {
        ...
        j = function(t) {
            var e = "scrollspy",
                ...
                C = function() {
                    function o(e, n) {
                        var i = this;
                        this._element = e, this._scrollElement = "BODY" === e.tagName ? window : e, this._config = this._getConfig(n), this._selector = this._config.target + " " + g + "," + this._config.target + " " + p + "," + this._config.target + " " + v, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, t(this._scrollElement).on(h.SCROLL, (function(t) {
                            return i._process(t)
                    ...
                    return u.refresh = function() {
                        ...
                        var i = t(n.join(","));
                        i.hasClass("dropdown-item") ? (i.closest(m).find(E).addClass(c), i.addClass(c)) : (i.addClass(c), i.parents(d).prev(g + ", " + p).addClass(c), i.parents(d).prev(_).children(g).addClass(c)), t(this._scrollElement).trigger(h.ACTIVATE, {
                            relatedTarget: e
                        })
                    }, u._clear = function() {
                        t(this._selector).filter(f).removeClass(c)
                    }, o._jQueryInterface = function(e) {
                        return this.each((function() {
                            var i = t(this).data(n);
            ...
            return t(window).on(h.LOAD_DATA_API, (function() {
                for (var e = t.makeArray(t(u)), n = e.length; n--;) {
                    var i = t(e[n]);
